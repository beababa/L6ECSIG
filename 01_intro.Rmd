...
```{r}
# lecture du fichier .csv (il est encodé UTF-8)
data <- read.csv("data/deroule.csv", header = T, fileEncoding = "UTF-8")
# Affichage du fichier avec mise en forme automatique
knitr::kable(data)
```
...
Le projet porte sur une thématique des défis et les données liées à ces défis, mais
toujours sur la commune choisie au départ.
...
library(sf)
library(mapview)
# affichage des couches du gpkg
st_layers("data/construction.gpkg")
# chargement de la couche ville
data <- st_read("data/construction.gpkg", "ville")
# affichage de la couche ville
mapview(data)
```



Autre cartographie possible
