...
table(df$dpt)
st_write(df, "data/cours3.gpkg", "commune", delete_layer = T, quiet = T)
```
...
st_write(inter, "data/cours3.gpkg", "car", delete_layer = T, quiet = T)
```
...
st_write(inter, "data/cours3.gpkg", "car97", delete_layer = T, quiet = T)
```
